...
export function SignInPage() {
  ...
  return <main className="auth-shell">
    ...
    <section className="auth-panel"><div className="auth-card"><h2>Continue to your organization</h2><p>Use the same account you use in theSpaces.</p>
      ...
      <p className="auth-help">Only organization administrators can continue.</p></div></section>
  </main>
}
