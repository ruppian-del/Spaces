...
object MockSpacesRepository {
    ...
    val spaces = listOf(
        Space("rupp-family", "Rupp Family", "🏡", "#3A6EA5", "3 new messages", SpaceTemplate.Family, "mock-ian", listOf("mock-ian"), 3, SpaceTemplate.Family.defaultEnabledModules, SpaceTemplate.Family.defaultModuleOrder),
        Space("arcinteractive", "ArcInteractive", "⚡", "#2F855A", "Standup starts at 9:00 AM", SpaceTemplate.Business, "mock-ian", listOf("mock-ian"), 7, SpaceTemplate.Business.defaultEnabledModules, SpaceTemplate.Business.defaultModuleOrder),
        Space("friends", "Friends", "🫶", "#D97706", "Weekend trip ideas", SpaceTemplate.Friends, "mock-ian", listOf("mock-ian"), null, SpaceTemplate.Friends.defaultEnabledModules, SpaceTemplate.Friends.defaultModuleOrder),
        Space("photography-club", "Photography Club", "📷", "#7C3AED", "Monthly challenge is live", SpaceTemplate.Community, "mock-ian", listOf("mock-ian"), 1, SpaceTemplate.Community.defaultEnabledModules, SpaceTemplate.Community.defaultModuleOrder)
    )
