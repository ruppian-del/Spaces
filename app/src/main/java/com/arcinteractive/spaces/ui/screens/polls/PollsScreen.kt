...
private fun PollOptionRow(
    ...
    Surface(
        modifier = Modifier
            .fillMaxWidth()
            .clickable(enabled = !poll.isClosed, onClick = onClick),
...
private fun CreatePollDialog(
    ...
    var optionOne by rememberSaveable { mutableStateOf("") }
    var optionTwo by rememberSaveable { mutableStateOf("") }
    var optionThree by rememberSaveable { mutableStateOf("") }
    var optionFour by rememberSaveable { mutableStateOf("") }
    var allowMultipleVotes by rememberSaveable { mutableStateOf(false) }
    var anonymous by rememberSaveable { mutableStateOf(false) }
    var autoClose by rememberSaveable { mutableStateOf(false) }
